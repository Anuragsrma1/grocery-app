  ...
  return (
    <div className='relative '>
        ...
        <div className='flex items-center mt-6 font-medium'>
           <Link className='group flex items-center gap-2 px-7 md:px-9 py-3 bg-primary 
             hover:bg-primary-dull transition text-white rounded-full cursor-pointer' to="/products">             
              Shop Now
             <img className='md:hidden transition group-focus:translate-x-1' src={assets.white_arrow_icon} alt='arrow'/>
           </Link>

           <Link className='group hidden md:flex items-center gap-2 px-9 py-3  
              cursor-pointer' to="/deals">             
              Explore Deals
